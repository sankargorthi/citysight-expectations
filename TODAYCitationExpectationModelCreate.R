...
weather_feats$Max_TemperatureF <- as.numeric(weather_feats$Max_TemperatureF)
weather_feats$Min_TemperatureF <- as.numeric(weather_feats$Min_TemperatureF)
weather_feats$Min_VisibilityMiles <- as.numeric(weather_feats$Min_VisibilityMiles)
weather_feats$Mean_Wind_SpeedMPH <- as.numeric(weather_feats$Mean_Wind_SpeedMPH)
weather_feats$PrecipitationIn <- as.numeric(weather_feats$PrecipitationIn)
